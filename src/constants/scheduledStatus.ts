 ...
 */
export const ACTIVE_SCHEDULED_STATES: ScheduledStatus[] = [
 ...
 */
export const TERMINAL_SCHEDULED_STATES: ScheduledStatus[] = [
 ...
 */
export const DRIVER_ACTION_REQUIRED_SCHEDULED_STATES: ScheduledStatus[] = [
 ...
 */
export const CANCELLABLE_SCHEDULED_STATES: ScheduledStatus[] = [
  SCHEDULED_STATUS.PENDING,
  SCHEDULED_STATUS.SEARCHING,
  SCHEDULED_STATUS.DRIVER_ACCEPTED,
  SCHEDULED_STATUS.REMINDER_30MIN_SENT,
 ...
 */
export function isScheduledRideActive(status: ScheduledStatus): boolean {
 ...
 */
export function isScheduledRideTerminal(status: ScheduledStatus): boolean {
 ...
 */
export function requiresDriverAction(status: ScheduledStatus): boolean {
 ...
 */
export function getScheduledStatusLabel(status: ScheduledStatus, role: 'driver' | 'passenger'): string {
  if (role === 'driver') {
    switch (status) {
