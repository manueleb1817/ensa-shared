...
// ═══════════════════════════════════════════════════════════
import { BASE_FARE, PER_MILE, PER_MINUTE, MINIMUM_FARE, CHARGE_PER_STOP, ENSA_COMMISSION_RATE, DRIVER_EARNINGS_RATE } from '../constants/config';
/**
 ...
 */
export const calculateFare = (distanceMiles, durationMinutes, numberOfStops = 0) => {
 ...
 */
export const calculateCommission = (fareAmount) => {
 ...
 */
export const calculateDriverEarnings = (fareAmount) => {
 ...
 */
export const calculateFareWithWaitTime = (distanceMiles, durationMinutes, stops) => {
    // Calcular base fare
