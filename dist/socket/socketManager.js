...
import { API_BASE_URL, SOCKET_RECONNECT_DELAY_WEB_MS, SOCKET_RECONNECT_DELAY_MOBILE_MS, SOCKET_MAX_RECONNECT_ATTEMPTS_WEB, SOCKET_MAX_RECONNECT_ATTEMPTS_MOBILE } from '../constants/config';
let socket = null;
 ...
 */
export const createSocket = (userId, token, apiUrl) => {
    ...
    socket.on('connect_error', (error) => {
        reconnectAttempts++;
        console.error(`[Socket Manager] [${platformName}] ❌ Connection error ` +
            `(${reconnectAttempts}/${MAX_RECONNECT_ATTEMPTS}):`, error.message);
 ...
 */
export const emitWithTimeout = (eventName, data, timeoutMs = 5000) => {
