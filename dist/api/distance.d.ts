 ...
 */
export declare const calculateRealDistance: (origin: Coordinates, destination: Coordinates, options?: DistanceOptions) => Promise<DistanceResult>;
/**
 ...
 */
export declare const calculateRouteWithStops: (origin: Coordinates, destination: Coordinates, waypoints?: Coordinates[], options?: DistanceOptions) => Promise<RouteWithStopsResult>;
/**
 ...
 */
export declare const calculateTripDistance: (driverLocation: Coordinates, pickupLocation: Coordinates, dropoffLocation: Coordinates, stops?: Coordinates[]) => Promise<{
